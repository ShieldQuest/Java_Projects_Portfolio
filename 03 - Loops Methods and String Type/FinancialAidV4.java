 ...
 *             
				an attempt at fixing the problem with the input of name
				a problem still exist for both .nextLine(): new line char
				and .next(): a blank inside the string will cause the stream to be 
				aborted and next string to overflow into a memory of the wrong type
				which implies a crash.
 */
package financialAidV4;
//imports:
import java.util.Scanner;

public class FinancialAidV4
{
	...
	public static void main(String[] args) 
	{
		...
		//process:
			while(answer == 1)
			{
				...
				name = get.next(); //using .next() instead of .nextLine()
				                   //won't work unless first and last are input separately
				                   //the .nextLine() will always add a new line char
				                   //to the buffer and this will affect the input for 
