/*
	...
	Description: this program prompts the user to input
             ...
             This program allows the user to repeat the whole program for a new division.
*/
package divisionV7;
//Imports:
import java.util.Scanner; 
import java.text.DecimalFormat;
public class DivisionV7                             
{
	public static void main(String[] args) 
	{
		 //declarations:
			...
			//working variables:
				int attempts = 0;
				int answer = 1; //1 means the while loop will start and zero to quit
			...
			//process:
		     while(answer == 1)
		     {
		    	//input:
					...
					//----------------
					//continue?
					System.out.println("Another division? enter 1 for yes or 0 for no: ");
					answer = get.nextInt();
		     }//end while(answer == 1)
			//goodbye!
